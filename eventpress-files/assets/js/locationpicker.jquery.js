(function ( $ ) {
    ...
    $.fn.locationpicker.defaults = {
        location: {latitude: 34.0727067, longitude: -118.29652140000002},
        locationName: "",
        radius: 1,
        zoom: 15,
        scrollwheel: true,
...
jQuery(document).ready(function($) {
    console.log(epcords);
$('#ep-maps').locationpicker({
location: {latitude: epcords.gmaplat, longitude: epcords.gmaplong},
locationName: "",
radius: 1,
inputBinding: {
    latitudeInput: $('#lat'),
    longitudeInput: $('#long'),
    radiusInput: $('#ep-maps-radius'),
    locationNameInput: $('#ep-maps-address')
},
